...
const BuildControl = props => {
    return (
        <div className="d-flex">
            <div className="ml-5" style={{ fontWeight: 'bold', fontSize: '1.5rem' }}>{props.label}</div>
            <button className="btn btn-danger btn-sm m-1 ms-auto" onClick={props.removed}>Less</button>
